...
object StringResources {
    ...
    var NEW_PASSWORD = tr("New password")
    var OLD_PASSWORD = tr("Old password")
    ...
    var CHANGE_PASSWORD = tr("Change password")
    var CHANGE_EMAIL = tr("Change email")
    ...
    var TOAST_UPDATE_SUCCESS = tr("Update successful")
    fun TOAST_FAILED_TO_CHANGE_PASSWORD(message: String?) = gettext("Failed to change password: %1", message)
